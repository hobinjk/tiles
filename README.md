#tiles
> Basic tiles game using Famo.us.

[![Build Status](https://travis-ci.org/hobinjk/tiles.svg?branch=master)](https://travis-ci.org/hobinjk/tiles) [![Dependency Status](https://david-dm.org/hobinjk/tiles.svg)](https://david-dm.org/hobinjk/tiles) [![devDependency Status](https://david-dm.org/hobinjk/tiles/dev-status.svg)](https://david-dm.org/hobinjk/tiles#info=devDependencies)
...
## Release History
 * 2014-07-14   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)